                    ...
                    <EuiFlexGroup direction="column">
                      <EuiFlexItem>
                        <EuiText>
                          <h3>Сценарий:</h3>
                          <ol>
                            <li>Арбитр на свой стороне обнаруживает запрос на подтверждение выплаты. Подверждает или отклоняет</li>
                            ...
                            <li>В случае статуса "Подтверждено" после нажатия кнопки "Получить выплату" с баланса страховой списывается сумма возмещения (указанная в договоре)</li>
